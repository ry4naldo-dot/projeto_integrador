    ...
    <section class="flex-1 p-4 lg:p-8">
        ...
        <div class="flex flex-col gap-4">
            ...
            <?php foreach ($VagasRecentes as $vr): ?>
                <a href="Vaga" class="bg-white border border-gray-200 rounded-lg p-5 hover:shadow-md hover:border-blue-300 transition-all curspr-pointer">
                    <div class="flex justify-between items-start">
                        <div>
